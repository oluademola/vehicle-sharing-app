...
def convert_to_megabyte(file_size):
    """
    This method converts recieved file size to megabyte.
    """
...
def custom_file_validator(file):
    """
    This method validates upload file format.
    """
    ...
    if file.size > FILE_UPLOAD_MAX_MEMORY_SIZE:
        raise ValidationError(
            f"File shouldn't be larger than {convert_to_megabyte(FILE_UPLOAD_MAX_MEMORY_SIZE)}MB."
        )
