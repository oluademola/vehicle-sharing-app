...
class Vehicle(BaseModel):
    ...
    registration_certificate = models.FileField(upload_to="vehicle certificates/", blank=True, null=True)
    ...
    availability_status = models.CharField(max_length=50, choices=choices.AVAILABILITY_STATUS, default="Available")
